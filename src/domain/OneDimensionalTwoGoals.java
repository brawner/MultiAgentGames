...
//	}
//	
//	private static JointRewardFunction generateJointReward(SGDomain domain) {
//		return new GridGame.GGJointRewardFunction(domain);
//	};
//	
//	private static StateGenerator generateStateGenerator(final Domain domain, final int width) {
//		
...
//		JointModel jointActionModel = OneDimensionalTwoGoals.generateJointActionModel(domain);
//		TerminalFunction terminalFunction = OneDimensionalTwoGoals.generateTerminalFunction(domain);
//		JointRewardFunction jointReward = OneDimensionalTwoGoals.generateJointReward(domain);
//		
//		StateGenerator stateGenerator = OneDimensionalTwoGoals.generateStateGenerator(domain, width);
