...
//			FullJointModel model = new GridGameStandardMechanicsWithoutTieBreaking(domain, semiWallProb);
...
//	}
//	
//	public static JointRewardFunction getSimultaneousGoalRewardFunction(final double goalReward, final double stepCost) {
//		return new JointRewardFunction() {
//
//			@Override
//			public Map<String, Double> reward(State s, JointAction ja, State sp) {
//				Map<String, Double> reward = new HashMap<String, Double>();
//				List<ObjectInstance> agents = sp.getObjectsOfClass(GridGame.CLASS_AGENT);
//				List<ObjectInstance> goals = sp.getObjectsOfClass(GridGame.CLASS_GOAL);
//				
//				boolean allPlayersInGoals = true;
//				for (ObjectInstance agent : agents) {
//					int playerNumber = agent.getIntValForAttribute(GridGame.VAR_PN);
//					int ax = agent.getIntValForAttribute(GridGame.VAR_X);
//					int ay = agent.getIntValForAttribute(GridGame.VAR_Y);
//					for (ObjectInstance goal : goals) {
//						int goalType = goal.getIntValForAttribute(GridGame.VAR_GT);
//						if (playerNumber + 1 == goalType) {
//							int gx = goal.getIntValForAttribute(GridGame.VAR_X);
//							int gy = goal.getIntValForAttribute(GridGame.VAR_Y);
//							if (ax != gx || ay != gy) {
...
//		List<ObjectInstance> horizontalWalls = startState.getObjectsOfClass(GridGame.CLASS_DIM_H_WALL);
//		List<ObjectInstance> verticalWalls = startState.getObjectsOfClass(GridGame.CLASS_DIM_V_WALL);
...
//		
//		final int cWidth = rightWall.getIntValForAttribute(GridGame.VAR_POS) - leftWall.getIntValForAttribute(GridGame.VAR_POS);
//		final int cHeight = topWall.getIntValForAttribute(GridGame.VAR_POS) - bottomWall.getIntValForAttribute(GridGame.VAR_POS); 
//		
