...
//
//
//	public static void writeGameToFile(GameEpisode result, String path, int matchNum, int round, String worldType) {
//		try {
...
//			List<ObjectInstance> agents = states.get(0).getObjectsOfClass(GridGame.CLASS_AGENT);
//			for (ObjectInstance agent : agents) {
//				if (agent.getIntValForAttribute(GridGame.VAR_PN) == 0) {
//					participantId1 = agent.getName();
//				} else if (agent.getIntValForAttribute(GridGame.VAR_PN)== 1 ) {
...
//
//		String toPrint = "";
//		results = new ArrayList<List<GameEpisode>>();
//
...
//			List<GameEpisode> gamesToSee = new ArrayList<GameEpisode>();
//			for(List<GameEpisode> games : results){
...
//		int match = 0;
//		for(List<GameEpisode> list : results){
//			int round = 0;
//			for (GameEpisode ga : list) {
...
//	}
//
//	private void outputMatchResults(String outputFolder, List<GameEpisode> rounds, int matchNum) {
//		//System.out.println("Outputting here: "+outputFolder);
//
//		int round = 0;
//		for (GameEpisode ga : rounds) {
